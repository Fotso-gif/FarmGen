# Generated by Django 5.2 on 2025-10-03 05:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('seller', 'Agriculteur/Vendeur'), ('client', 'Client/Utilisateur')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialty', models.CharField(choices=[('legumes', 'Légumes'), ('fruits', 'Fruits'), ('cereales', 'Céréales'), ('tubercules', 'Tubercules'), ('elevage', 'Élevage'), ('produits_laitiers', 'Produits Laitiers'), ('volailles', 'Volailles'), ('apiculture', 'Apiculture'), ('autres', 'Autres')], max_length=20)),
